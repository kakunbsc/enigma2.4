...
class TimerEntry(Screen, ConfigListScreen):
	...
	def createConfig(self):
			...
			self.timerentry_justplay = ConfigSelection(choices = [("zap", _("zap")), ("record", _("record")), ("epg", _("Download EPG"))], default = {0: "record", 1: "zap", 2: "epg"}[justplay])
	...
	def createSetup(self, widget):
		...
		elif self.timerentry_justplay.value == "epg":
			self.list.append(getConfigListEntry(_("After event"), self.timerentry_afterevent))
	...
	def keyGo(self):
		...
		self.timer.justplay = {"record":0,"zap":1,"epg":2}[self.timerentry_justplay.value]
